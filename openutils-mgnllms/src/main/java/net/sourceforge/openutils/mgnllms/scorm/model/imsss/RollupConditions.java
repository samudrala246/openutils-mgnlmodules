...
public class RollupConditions
{
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link RollupCondition }
     */
    public List<RollupCondition> getRollupCondition()
    {
        if (rollupCondition == null)
        {
            rollupCondition = new ArrayList<RollupCondition>();
        }
    ...
    public ConditionCombination getConditionCombination()
    {
        ...
        {
            return ConditionCombination.ANY;
        }
        else
        {
