...
/**
 * Implementation of {@link ImageResolutionProcessor} that render image to fit inside the required resolution.
 * @author molaschi
 * @version $Id: $
 */
public class FitInImageResolutionProcessor extends BaseImageResolutionProcessor
{
