 ...
 * @version $Id$
 */
public class MultiBundleMgnlMessagesManager extends DefaultMessagesManager
{
    ...
    protected Messages newMessages(MessagesID messagesID)
    {
        ...
        Messages multiBundle = new MultiBundleMessagesImpl(messagesID.getLocale());

        return new MessagesChain(repositoryMsg).chain(multiBundle).chain(parentMessages);
    }
