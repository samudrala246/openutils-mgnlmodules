<jsp:root version="2.0" xmlns:jsp="http://java.sun.com/JSP/Page" xmlns:c="http://java.sun.com/jsp/jstl/core"
  ...
  <pre>
    <![CDATA[&lt;c:set var="hint" value="${'$'}{mcmenu:entryValue(content.JCRNode, 'firstname-hint')}" /&gt;]]>
  </pre>
  <br />
  ...
  <dl>
    ...
    <dd>
      ...
      <c:set var="hint" value="${mcmenu:entryValue(content.JCRNode, 'firstname-hint')}" />
    ...
    <dd>
      ...
      <c:set var="hint" value="${mcmenu:entryValue(content.JCRNode, 'lastname-hint')}" />
      <c:if test="${not empty hint}">
        <span class="hint">
          <![CDATA[${hint}<span class="hint-pointer">&nbsp;</span>]]>
        </span>
    ...
    <dd>
      ...
      <c:set var="hint" value="${mcmenu:entryValue(content.JCRNode, 'email-hint')}" />
      <c:if test="${not empty hint}">
        <span class="hint">
          <![CDATA[${hint}<span class="hint-pointer">&nbsp;</span>]]>
        </span>
    ...
    <dd>
      ...
      <c:set var="hint" value="${mcmenu:entryValue(content.JCRNode, 'year-hint')}" />
      <c:if test="${not empty hint}">
        <span class="hint">
          <![CDATA[${hint}<span class="hint-pointer">&nbsp;</span>]]>
        </span>
    ...
    <dd>
      ...
      <c:set var="hint" value="${mcmenu:entryValue(content.JCRNode, 'username-hint')}" />
      <c:if test="${not empty hint}">
        <span class="hint">
          <![CDATA[${hint}<span class="hint-pointer">&nbsp;</span>]]>
        </span>
    ...
    <dd>
      ...
      <c:set var="hint" value="${mcmenu:entryValue(content.JCRNode, 'password-hint')}" />
      <c:if test="${not empty hint}">
        <span class="hint">
          <![CDATA[${hint}<span class="hint-pointer">&nbsp;</span>]]>
        </span>
